...
def load_database():
    ...
    base_ativos = pd.read_csv('/app/Ativos.csv', sep=';')
...
if __name__ == '__main__':
    ...
    print(f'\n IRR Rate:   {round(rate,6) *100}%')
    print(f'\n Taxa Selic {max_date}: {selic_rate}')

    print(f"\n Projeção de Taxa Selic Acumulada entre {base_ativos['vencimento'].min()} "
